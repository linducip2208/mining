...
class BfjSalesRecapReconciliationTest extends AdminFlowTestCase
{
    public function test_detail_vs_recap_variance_reported(): void
    {
        ...
        $s = LegacyImportSheet::create(['batch_id' => $b->id, 'sheet_name' => 'REKAP BFJ', 'detected_type' => 'SALES', 'confidence' => 80, 'row_count' => 1, 'is_summary' => true, 'action' => 'RECONCILE_ONLY']);
        LegacyImportRow::create(['sheet_id' => $s->id, 'row_number' => 2, 'source' => [], 'normalized' => ['dimension' => '2026-09-01', 'volume_total' => 12], 'fingerprint' => uniqid(), 'status' => 'IMPORTED']);
