...
class BfjStockCardReconciliationTest extends AdminFlowTestCase
{
    public function test_stock_card_reconciled(): void
    {
        ...
        LegacyImportRow::create(['sheet_id' => $s->id, 'row_number' => 2, 'source' => [], 'normalized' => ['KODE' => 'SPR-001', 'STOK MASUK' => 10, 'STOK KELUAR' => 2, 'SALDO' => 8], 'fingerprint' => uniqid(), 'status' => 'IMPORTED']);
