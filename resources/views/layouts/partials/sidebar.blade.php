@php
    $groups = [
        ...
        ['label' => 'Energi & Stok', 'icon' => 'fuel', 'items' => [
            ['label' => 'Fuel Control', 'route' => 'fuel.dashboard', 'active' => 'fuel.*', 'perm' => 'fuel.view', 'icon' => 'fuel'], ['label' => 'Stockpile Board', 'route' => 'stockpiles.dashboard', 'active' => 'stockpiles.*', 'perm' => 'stockpile.view', 'icon' => 'warehouse'], ['label' => 'Inventory', 'route' => 'stock.balance', 'active' => 'stock.*', 'perm' => 'stock.view', 'icon' => 'box'], ['label' => 'Gudang Sparepart', 'route' => 'sparepart.dashboard', 'active' => 'sparepart.*', 'perm' => 'sparepart.view', 'icon' => 'wrench']]],
        ...
        ['label' => 'Marketing', 'icon' => 'globe', 'items' => [
            ['label' => 'SEO Dashboard', 'route' => 'marketing.seo.dashboard', 'active' => 'marketing.seo.*', 'perm' => 'marketing.view', 'icon' => 'globe'], ['label' => 'SEO Pages', 'route' => 'marketing.seo.pages', 'active' => 'marketing.seo.pages*', 'perm' => 'marketing.view', 'icon' => 'layers']]],
        ['label' => 'Administrasi', 'icon' => 'sliders', 'items' => [['label' => 'Control Center', 'route' => 'administration.dashboard', 'active' => 'administration.*', 'perm' => 'letter.view', 'icon' => 'dashboard'], ['label' => 'Register Surat', 'route' => 'letters.index', 'active' => 'letters.*', 'perm' => 'letter.view', 'icon' => 'file'], ['label' => 'Register Invoice', 'route' => 'invoice-register.index', 'active' => 'invoice-register.*', 'perm' => 'invoice_register.view', 'icon' => 'money'], ['label' => 'Register Kwitansi', 'route' => 'receipts.index', 'active' => 'receipts.*', 'perm' => 'receipt.view', 'icon' => 'coin'], ['label' => 'Import Data', 'route' => 'imports.index', 'active' => 'imports.*', 'perm' => 'legacy_import.review', 'icon' => 'external'], ['label' => 'Pengguna', 'route' => 'users.index', 'active' => 'users.*', 'perm' => 'user.view', 'icon' => 'users'], ['label' => 'Peran & Izin', 'route' => 'role.index', 'active' => 'role.*', 'perm' => 'role.view', 'icon' => 'shield'], ['label' => 'Pengaturan Sistem', 'route' => 'setting.index', 'active' => 'setting.*', 'perm' => 'setting.view', 'icon' => 'cog'], ['label' => 'Printer & Perangkat', 'route' => 'printer.index', 'active' => 'printer.*', 'perm' => 'printer.view', 'icon' => 'printer'], ['label' => 'Approval Workflow', 'route' => 'setting.approval-workflow', 'active' => 'setting.approval-workflow*', 'perm' => 'approval.workflow.view', 'icon' => 'layers'], ['label' => 'Kesehatan Sistem', 'route' => 'setting.health', 'active' => 'setting.health', 'perm' => 'setting.view', 'icon' => 'heart']]],
    ];
