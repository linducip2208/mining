...
<head>
    ...
    <title>{{ $code }} · {{ $title }} · {{ \App\Services\BrandingService::appName() }}</title>
...
<div class="min-h-screen flex items-center justify-center p-6"><div class="bg-white dark:bg-navy-800 rounded-2xl border border-slate-200 dark:border-slate-700 shadow-card p-10 max-w-md w-full text-center">
    ...
    <div class="mt-6 flex justify-center gap-2"><a href="{{ url('/dashboard') }}" class="inline-block px-5 py-2.5 rounded-ctl bg-amber-500 hover:bg-amber-600 text-white text-sm font-semibold">Kembali ke Dashboard</a><a href="/docs/troubleshooting/common" class="inline-block px-5 py-2.5 rounded-ctl bg-slate-100 dark:bg-white/10 text-sm">Bantuan</a></div>
</div></div>
</body></html>
