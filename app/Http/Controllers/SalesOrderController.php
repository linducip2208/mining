...
class SalesOrderController extends Controller
{
    ...
    public function create()
    {
        return view('sales.so.form', [
            ...
            'taxRate' => (float) TaxCode::where('code', \App\Models\Setting::get('tax.default_sales_tax_code', 'PPN11'))->value('rate'),
        ]);
    }
    ...
    {
        try {
            $warehouse = \App\Models\Setting::get('inventory.default_warehouse_id');
    ...
    protected function syncLines(SalesOrder $so, Request $request): void
    {
        ...
        $tax = round($subtotal * (float) TaxCode::where('code', \App\Models\Setting::get('tax.default_sales_tax_code', 'PPN11'))->value('rate') / 100, 2);
